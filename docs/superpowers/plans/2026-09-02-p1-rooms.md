...
**Interfaces:**
- Produces:
  - `public struct Room: Codable, Hashable, Sendable, Identifiable { id: UUID; name: String; inviteCode: String; timezone: String; maxMembers: Int; createdBy: UUID; createdAt: Date }`
