...
- Produces:
  ...
  - `public enum RoomError: Error, Equatable, Sendable { invalidCode, roomFull, alreadyMember, rateLimited, notMember, invalidName, invalidTimezone, profileRequired, notAuthenticated, unknown(String); init(serverMessage:); var userMessage: String }`
